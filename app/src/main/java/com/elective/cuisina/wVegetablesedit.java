...
public class wVegetablesedit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wactivity_wvegetablesedit);
    ...
    public void Delete()
    {
        try
        {
            ...
            String sql = "delete from records4 where id = ?";
    ...
    public void Edit()
    {
        try
        {
            ...
            String sql = "update records4 set name = ?,course=?,fee=? where id= ?";
            SQLiteStatement statement = db.compileStatement(sql);
