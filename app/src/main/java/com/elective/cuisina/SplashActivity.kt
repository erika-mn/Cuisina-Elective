...
import com.elective.cuisina.database.RecipeDatabase
import com.elective.cuisina.entities.Category
import com.elective.cuisina.entities.Meal
import com.elective.cuisina.entities.MealsItems
import com.elective.cuisina.interfaces.GetDataService
import com.elective.cuisina.retofitclient.RetrofitClientInstance
...
class SplashActivity : BaseActivity(), EasyPermissions.RationaleCallbacks,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnGetStarted.setOnClickListener {
            var intent = Intent(this@SplashActivity, MainMenuActivity::class.java)
