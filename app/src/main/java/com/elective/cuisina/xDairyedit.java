...
public class xDairyedit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xactivity_xdairyedit);
    ...
    public void Delete()
    {
        try
        {
            ...
            String sql = "delete from records3 where id = ?";
    ...
    public void Edit()
    {
        try
        {
            ...
            String sql = "update records3 set name = ?,course=?,fee=? where id= ?";
            SQLiteStatement statement = db.compileStatement(sql);
