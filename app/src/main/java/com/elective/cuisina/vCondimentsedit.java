...
public class vCondimentsedit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vactivity_vcondimentsedit);
    ...
    public void Delete()
    {
        try
        {
            ...
            String sql = "delete from records5 where id = ?";
    ...
    public void Edit()
    {
        try
        {
            ...
            String sql = "update records5 set name = ?,course=?,fee=? where id= ?";
            SQLiteStatement statement = db.compileStatement(sql);
